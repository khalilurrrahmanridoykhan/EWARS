...
export default function MalariaSpecies() {
    ...
    useEffect(() => {
        ...
        function hideLabels() {
            const nodes = document.querySelectorAll('.zoomlabel-marker');
            if (nodes.length > 0) {
                nodes.forEach(el => {
                    el.style.opacity = '0';
                ...
                tries += 1;
                setTimeout(hideLabels, 100);
            }
        }

        hideLabels();

        // Optionally, cleanup: stop polling if the component unmounts early
